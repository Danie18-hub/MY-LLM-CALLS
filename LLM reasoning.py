...
messages = [
    ...
    "Before providing your final answer walk through this step by step"
    "Break down the problem into smaler steps"
    "Address each step systematically"
    "Show your reasoning for each step"
    "Then provide your final conclusion"),
    HumanMessage(content=f"""
                  Based on this publication:{publication_content}
                  Write the summary of the above publication""")]
