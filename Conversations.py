...
conversation = [
    SystemMessage(content=f"""
                  ...
                  Base your answers only on this publication content:{publication_content}""")
]

conversation.append(HumanMessage(content="""What are VAEs and list the top 5 application for them as discussed in this publication."""))

response1 = llm.invoke(conversation)
print("AI response to Question1:")
...
print("AI response to Question2:")
